   ...
   <div class="row footer_1">
     <div class="col-md-2">
	  <div class="footer_1i">
	   ...
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Korean Movie</a></h6>
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Chinese Movie</a></h6>
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Japanese Movie</a></h6>
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Spanish Movie</a></h6>
	   <h6 class="mb-0 mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#"> German Movie</a></h6>
	   </div>
	  </div>
	 </div>
	 <div class="col-md-4">
	 ...
	 <div class="col-md-2">
	  <div class="footer_1i">
	   ...
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Sci-fi Movie</a></h6>
	   <h6 class="mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Crime Movie</a></h6>
	   ...
	   <h6 class="mb-0 mt-2 col-md-12 col-6"><i class="fa fa-circle me-1 col_red font_10"></i> <a class="text-muted" href="#">Horror Movie</a></h6>
	   </div>
 ...
 <div class="container-xl">
   ...
   <div class="col-md-8">
    <div class="footer_b1l">
	 <p class="mb-0 fs-6 text-muted mt-1">© 2023 Films Box. All Rights Reserved | Design by <a class="col_red" href="http://www.templateonweb.com">Simon@Zarni</a></p>
	</div>
   </div>
   <div class="col-md-4">
